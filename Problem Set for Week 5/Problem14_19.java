...
public class Problem14_19 extends Application{
    ...
    private static void drawXAxis(Pane pane, Polyline xAxis){
        ...
        //Creates the arrow at end of x axis
    ...
    private static void drawYAxis(Pane pane, Polyline yAxis){
        ...
        //Creates the arrow at end of y axis
        Line line1 = new Line(CENTER_X, HEIGHT * 0.1, CENTER_X - WIDTH * 0.05,
                HEIGHT * 0.2);
        Line line2 = new Line(CENTER_X, HEIGHT * 0.1, CENTER_X + WIDTH * 0.05, 
                HEIGHT * 0.2);
