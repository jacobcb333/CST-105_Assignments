...
marking an available cell in a 3 x 3 grid with their respective tokens either 
...
determines the statis of the game (win, draw, or continue). Here is a sample run.
 */
